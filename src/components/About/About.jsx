      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-6 leading-relaxed">
            ...
            back-end development, I specialize in the MERN stack, React Native
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-5">
            {/* Resume Button */}
            <a
              href="https://drive.google.com/file/d/1NCY4Ws0_-_UsBDTh3x2fRsClXRwu5sPv/view?usp=sharing"
              target="_blank"
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          <Tilt
            className="w-48 h-48 sm:w-64 sm:h-64 md:w-[25rem] md:h-[28rem] border-4 border-purple-700 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
